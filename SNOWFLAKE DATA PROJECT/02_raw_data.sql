...
comment = 'This is raw table to store all the JSON files with root elements extracted';
...
--to check if any files failed, clink on the table --> Copy History
--if a file failed, remove it and reload using +File and re run COPY INTO command
